...
![img](E:/md_picture/1743950488705-53.jpeg)
...
![img](E:/md_picture/1743950488703-1.png)
...
![img](E:/md_picture/1743950488703-2.png)

2）运行

将jar包放在任意非中文、不包含特殊字符的目录下，重命名为`sentinel-dashboard.jar`：

![img](E:/md_picture/1743950488703-3.png)
...
![img](E:/md_picture/1743950488704-4.png)

需要输入账号和密码，默认都是：sentinel

登录后，即可看到控制台，默认会监控sentinel-dashboard服务本身：

![img](E:/md_picture/1743950488704-5.png)
...
![img](E:/md_picture/1743950488704-6.png)

点击簇点链路菜单，会看到下面的页面：

![img](E:/md_picture/1743950488704-7.png)
...
![img](E:/md_picture/1743950488704-8.png)
...
![img](E:/md_picture/1743950488704-9.png)

## 1.3.请求限流

在簇点链路后面点击流控按钮，即可对其做限流配置：

![img](E:/md_picture/1743950488704-10.png)

在弹出的菜单中这样填写：

![img](E:/md_picture/1743950488704-11.png)

这样就把查询购物车列表这个簇点资源的流量限制在了每秒6个，也就是最大QPS为6.

我们利用Jemeter做限流测试，我们每秒发出10个请求：

![img](E:/md_picture/1743950488704-12.png)

最终监控结果如下：

![img](E:/md_picture/1743950488704-13.png)
...
![img](E:/md_picture/1743950488704-14.png)

### 1.4.2.配置线程隔离

接下来，点击查询商品的FeignClient对应的簇点资源后面的流控按钮：

![img](E:/md_picture/1743950488704-15.png)

在弹出的表单中填写下面内容：

![img](E:/md_picture/1743950488704-16.png)

注意，这里勾选的是并发线程数限制，也就是说这个查询功能最多使用5个线程，而不是5QPS。如果查询商品的接口每秒处理2个请求，则5个线程的实际QPS在10左右，而超出的请求自然会被拒绝。

![img](E:/md_picture/1743950488704-17.png)

我们利用Jemeter测试，每秒发送100个请求：

![img](E:/md_picture/1743950488704-18.png)

最终测试结果如下：

![img](E:/md_picture/1743950488704-19.png)

进入查询购物车的请求每秒大概在100，而在查询商品时却只剩下每秒10左右，符合我们的预期。

此时如果我们通过页面访问购物车的其它接口，例如添加购物车、修改购物车商品数量，发现不受影响：

![img](E:/md_picture/1743950488704-20.png)
...
![img](E:/md_picture/1743950488704-21.png)
...
![img](E:/md_picture/1743950488704-22.png)

**步骤三**：在`hm-api`模块中的`ItemClient`接口中使用`ItemClientFallbackFactory`：

![img](E:/md_picture/1743950488704-23.png)

重启后，再次测试，发现被限流的请求不再报错，走了降级逻辑：

![img](E:/md_picture/1743950488704-24.png)

但是未被限流的请求延时依然很高：

![img](E:/md_picture/1743950488704-25.png)
...
![img](E:/md_picture/1743950488704-26.png)

在弹出的表格中这样填写：

![img](E:/md_picture/1743950488704-27.png)
...
![img](E:/md_picture/1743950488704-28.png)

在一开始一段时间是允许访问的，后来触发熔断后，查询商品服务的接口通过QPS直接为0，所有请求都被熔断了。而查询购物车的本身并没有受到影响。

此时整个购物车查询服务的平均RT影响不大：

![img](E:/md_picture/1743950488704-29.png)
...
![img](E:/md_picture/1743950488704-30.png)

目前有4个购物车，然结算下单，进入订单结算页面：

![img](E:/md_picture/1743950488704-31.png)

然后将购物车中某个商品的库存修改为`0`：

![img](E:/md_picture/1743950488704-32.png)

然后，提交订单，最终因库存不足导致下单失败：

![img](E:/md_picture/1743950488705-33.png)

然后我们去查看购物车列表，发现购物车数据依然被清空了，并未回滚：

![img](E:/md_picture/1743950488705-34.png)
...
![img](E:/md_picture/1743950488705-35.png)
...
![img](E:/md_picture/1743950488705-36.png)

### 2.2.2.准备配置文件

课前资料准备了一个seata目录，其中包含了seata运行时所需要的配置文件：

![img](E:/md_picture/1743950488705-37.png)

其中包含中文注释，大家可以自行阅读。

我们将整个seata文件夹拷贝到虚拟机的`/root`目录：

![img](E:/md_picture/1743950488705-38.png)
...
![img](E:/md_picture/1743950488705-39.png)
...
![img](E:/md_picture/1743950488705-40.png)
...
![img](E:/md_picture/1743950488705-41.png)
...
![img](E:/md_picture/1743950488705-42.png)

结果：

![img](E:/md_picture/1743950488705-43.png)
...
![img](E:/md_picture/1743950488705-44.png)
...
![img](E:/md_picture/1743950488705-45.png)

异常情况：

![img](E:/md_picture/1743950488705-46.png)
...
![img](E:/md_picture/1743950488705-47.png)
...
![img](E:/md_picture/1743950488705-48.png)
...
![img](E:/md_picture/1743950488705-49.png)
...
![img](E:/md_picture/1743950488705-50.png)
...
![img](E:/md_picture/1743950488705-51.png)
...
![img](E:/md_picture/1743950488705-52.png)
