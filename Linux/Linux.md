...
![图片](https://mmbiz.qpic.cn/mmbiz_png/uJDAUKrGC7L1I72C1HrwJ9bG6XAbVggM4RsQuEaoMI78gr3jGxkVH7ONWyDHmremOHiaUibc3sqPRfEuVuHqicfqA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
永久改主机名：hostnamect| set-hostname
...
ps -xx|grep进程名（过滤进程信息，即显示指定进程信息）
...
```
 ...
 ![screenshot-1730812750191](E:/md_picture/screenshot-1730812750191.png)
...
1、rpm下载地址 [jdk-21.0.2_linux-x64_bin.rpm](..\..\..\..\Downloads\jdk-21.0.2_linux-x64_bin.rpm) 
...
一般来说，开了tomcat就很难关闭，因为 Tomcat 是通过 `jsvc` 或者其他守护进程方式启动的，使用 `shutdown.sh` 脚本可能没有停止 Tomcat。`shutdown.sh` 依赖于正确的 PID 文件来确定停止进程。如果 PID 文件不存在或配置不正确，Tomcat 可能没有正确停止。
...
root         928  0.0  0.0   2824   116 ?        Ss   23:13   0:00 jsvc.exec -java-home /usr/lib/jvm/jdk-21-oracle-x64 -user www -pidfile /www/server/tomcat/logs/catalina-daemon.pid -wait 10 -umask 0027 -outfile /www/server/tomcat/logs/catalina-daemon.out -errfile &1 -classpath /www/server/tomcat/bin/bootstrap.jar:/www/server/tomcat/bin/commons-daemon.jar:/www/server/tomcat/bin/tomcat-juli.jar -Djava.util.logging.config.file=/www/server/tomcat/conf/logging.properties -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager -Dignore.endorsed.dirs= -Dcatalina.base=/www/server/tomcat -Dcatalina.home=/www/server/tomcat -Djava.io.tmpdir=/www/server/tomcat/temp org.apache.catalina.startup.Bootstrap
www          931  0.7  6.9 3022064 126740 ?      Sl   23:13   0:05 jsvc.exec -java-home /usr/lib/jvm/jdk-21-oracle-x64 -user www -pidfile /www/server/tomcat/logs/catalina-daemon.pid -wait 10 -umask 0027 -outfile /www/server/tomcat/logs/catalina-daemon.out -errfile &1 -classpath /www/server/tomcat/bin/bootstrap.jar:/www/server/tomcat/bin/commons-daemon.jar:/www/server/tomcat/bin/tomcat-juli.jar -Djava.util.logging.config.file=/www/server/tomcat/conf/logging.properties -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager -Dignore.endorsed.dirs= -Dcatalina.base=/www/server/tomcat -Dcatalina.home=/www/server/tomcat -Djava.io.tmpdir=/www/server/tomcat/temp org.apache.catalina.startup.Bootstrap
root        3384  0.0  0.1   6612  2260 pts/0    S+   23:24   0:00 grep --color=auto tomcat

则 928   931  就为进程号 
kill -9 928  和 kill -9 931  就可以彻底杀死tomcat
...
![屏幕截图_7-11-2024_1177_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_1177_www.bilibili.com.jpeg)



![屏幕截图_7-11-2024_11740_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_11740_www.bilibili.com.jpeg)



![屏幕截图_7-11-2024_11831_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_11831_www.bilibili.com.jpeg)



![屏幕截图_7-11-2024_11851_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_11851_www.bilibili.com.jpeg)

这是虚拟机默认的网段，要用vim编辑



![屏幕截图_7-11-2024_111542_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_111542_www.bilibili.com.jpeg)



![屏幕截图_7-11-2024_11922_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_11922_www.bilibili.com.jpeg)



![屏幕截图_7-11-2024_111654_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_111654_www.bilibili.com.jpeg)
...
![屏幕截图_7-11-2024_111016_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_111016_www.bilibili.com.jpeg)
...
![屏幕截图_7-11-2024_111122_www.bilibili.com](E:/md_picture/屏幕截图_7-11-2024_111122_www.bilibili.com.jpeg)
